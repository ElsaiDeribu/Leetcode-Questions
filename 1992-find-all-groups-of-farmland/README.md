...
<pre style="position: relative;"><strong>Input:</strong> land = [[1,0,0],[0,1,1],[0,1,1]]
...
<pre style="position: relative;"><strong>Input:</strong> land = [[1,1],[1,1]]
...
<pre style="position: relative;"><strong>Input:</strong> land = [[0]]
